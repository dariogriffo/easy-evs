namespace EasyEvs.Tests
{
    ...
    public class PreActionsTests
    {
        ...
        public async Task When_Actions_Are_Registered_They_Are_Executed()
        {
            ...
            services.AddScoped<IPreHandlesEventAction<OrderRefundRequested>, OrderEventPreAction1>();
            services.AddScoped<IPreHandlesEventAction<OrderRefundRequested>, OrderEventPreAction2>();
            ...
            var @event = new OrderRefundRequested(Guid.NewGuid(), DateTime.UtcNow, orderId, 5, false);
