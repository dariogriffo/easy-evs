namespace EasyEvs.Contracts
{
    ...
    public interface IPostHandlesEventAction<in T> : IPostHandlesEventAction
        where T : IEvent
    {
        /// <summary>
        ...
        Task<OperationResult> Execute([NotNull]T @event, IConsumerContext context, OperationResult result, CancellationToken cancellationToken);
    }
}
